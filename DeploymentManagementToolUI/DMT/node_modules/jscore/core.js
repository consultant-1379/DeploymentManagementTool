...
define('jscore/ext/dom',[
    ...
    Element.prototype = {
         ...
         *   <ul>
         *     <li>title: The text displayed in case of input error</li>
    ...
    var dom = {
         ...
         *
         * @example
         *    dom.removeModifier(element, "disabled");
         *    dom.removeModifier(element, "disabled", "ebBtn");
         */
        ...
        setValidator: function (element, options, required) {
            ...
            if (element._getHTMLElement().tagName.toLowerCase() === 'input') {
                ...
                if (typeof options === 'string' || options instanceof String) {
                    ...
                    else if (validationPatterns[options] !== undefined) {
                        typeDesc = validationPatterns[options];
                    } else {
                        throw new Error("Type '" + options + "' not supported.");
                    }
                } else if (typeof options === 'object' && options.title && options.pattern) {
                    typeDesc = options;
                }
...
define('jscore/core',[
    ...
    return {
        ...
        _private: _private,
        version: "1.0.84" // TODO: remove hardcode
    };
});
