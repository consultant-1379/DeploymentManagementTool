...
define('widgets/Breadcrumb/Breadcrumb',[
    ...
    return WidgetCore.extend({
         ...
         */
        onViewReady: function () {
            this.setData(this.options.breadcrumbs || []);
        ...
        /**
         * Updates the widget with the new breadcrumb data. For more details refer to the constructor documentation.
         *
         * @method setData
         * @param {Object} breadcrumbs
         */
        setData: function (breadcrumbs) {
            clear.call(this);
            this.breadcrumbItems = breadcrumbs.map(function (breadcrumbObj) {
    ...
    /**
     * Detaches all existing breadcrumb items.
     *
     * @method clear
     * private
     */
