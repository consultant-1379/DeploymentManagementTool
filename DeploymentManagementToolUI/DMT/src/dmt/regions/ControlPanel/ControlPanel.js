define([
    ...
    "../../widgets/InfoPopupWrapper/InfoPopupWrapper"
], function(core, View, RepositionTreeWidget, ZoomControlWidget, InfoPopupWrapper) {
    /**
    ...
    return core.Region.extend({
        ...
        onStart: function() {
            ...
            var infoPopupWrapper = new InfoPopupWrapper();
